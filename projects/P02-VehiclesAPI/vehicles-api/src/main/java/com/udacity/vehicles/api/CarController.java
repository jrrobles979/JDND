...
@ApiResponses(value = {
        ...
        @ApiResponse(code=403, message = "You don't have permissions to access this function"),
        @ApiResponse(code=404, message = "Vehicle not found, check if is a valid vehicle id")
})
